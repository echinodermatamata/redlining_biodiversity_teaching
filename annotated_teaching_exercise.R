...
#### INCLUDE NOTES HERE ON OPENING A PROJECT SO THAT THE DATA GETS PROPERLY IMPORTED
### This is a good spot to be explicit about good file management practices
...
data2018<- read.delim("ebd_US-GA-121_201801_201812_relMar-2021/ebd_US-GA-121_201801_201812_relMar-2021.txt")


#####This code comes directly from Appendix 5 of Callaghan 2017
...
### Our dataframe has 49 variables- which is a lot, so let's take out only the variables we really want
# The distinct() is in the dplyr package removes duplicates and keeps only each unique sampling event in the dataset
...
### Renamed again to analysis_data.all -- let's just change this name for all downstream analysis from here
##Rename "analysis_data_95_seasons"
